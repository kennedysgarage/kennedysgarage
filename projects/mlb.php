<?php  $title = 'MLB |'; include '../header.php'; ?>
  ...
  <div class="container">
    <div class="page">
      <div class="hero"><span><img src="/projects/assets/mlb/hero.png"/></span></div>

      <div class="content">

        <div class="g3 description">
          <h3>Project Description</h3>
          <p>MLB.com is the official site of Major League Baseball and is overseen by Major League Baseball Advanced Media. MLB.com is a source of baseball-related information, including baseball news, statistics, and sports columns.</p>
        </div><!--/g3-->
        <div class="g1 role">
          <h3>My Role</h3>
          <ul>
