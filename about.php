<?php  $title = 'About'; include 'header.php'; ?>
	...
	<div id="page" class="clearfix about">

		<div class="g4">
		<img src="/img/home/face.png"/>
	  <h2>About Me</h2>
	  <p>I have always been <strong>passionate about the overall user experience</strong> of the product and a keen eye for the details while keeping a clear vision of the big picture. Lately my main focus has been UX design for tablet &amp; mobile applications, however I have designed and launched several successful websites over the past eight years.</p>
